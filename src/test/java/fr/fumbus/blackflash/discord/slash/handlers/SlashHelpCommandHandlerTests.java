...
class SlashHelpCommandHandlerTests {
    ...
    void handle_repliesWithNotImplementedMessage() {
        ...
        verify(event).reply("🚧 The /help command is not implemented yet. Stay tuned!");
        verify(event.reply("🚧 The /help command is not implemented yet. Stay tuned!")).setEphemeral(true);
    }
}
